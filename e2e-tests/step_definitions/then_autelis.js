...
Then(/^Autelis (Pool parameters are displayed|Spa and Solar parameters are displayed|SPA-POOL parameters turned off) on Autelis page$/, (parametersStatus) => {
...
Then(/^Autelis (Blower|Cleaner|Jets|Pool Heat|Pool Light|Solar|Spa Heat|Spa Light|Waterfall) button is (enabled|disabled)$/, (buttonName, state) => {
    switch (buttonName) {
        case 'Blower':
            state === 'enabled'
