...
When(/^User clicks on (Ceiling Fan Light|Ceiling Fan|Office Dimmer|Office Light|Office Fan|Kitchen Light) button to change state to (On|Off|Low|Medium|High) on SmartThings page$/, (buttonName, state) => {
    switch (buttonName) {
