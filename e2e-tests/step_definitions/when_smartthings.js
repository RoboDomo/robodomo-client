...
When(
    /^User clicks on (Theater|Office|Back Room|Bedroom|Kitchen|Bathroom|Outside) tab on SmartThings page$/,
    tabName => {
        switch (tabName) {
            case 'Theater':
...
When(
    /^User changes SmartThings (Ceiling Fan Light|Ceiling Fan|Entryway Lights|Kitchen Light|Office Dimmer|Office Light|Office Fan) button state to (On|Off|Low|Medium|High)$/,
    (buttonName, state) => {
        switch (buttonName) {
...
When(
    /^User changes SmartThings (Entryway Lights|Bedroom Lamp|Bedroom Fan|Bedroom Light) button state to (On|Off|Low|Medium|High)$/,
    (buttonName, state) => {
        switch (buttonName) {
            case 'Entryway Lights':
                switch (state) {
...
When(
    /^User changes SmartThings (Porch Light|Outside Light|Outdoor Lights) button state to (On|Off|Low|Medium|High)$/,
    (buttonName, state) => {
        switch (buttonName) {
            case 'Porch Light':
                switch (state) {
