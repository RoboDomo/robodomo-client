...
class KitchenTabComponent {
    ...
    get kitchenLightSwitch() { return this.activeTab.$('.//ion-card[contains(., "Kitchen Light")]//ion-toggle'); }
    get kitchenLightDimm() { return this.activeTab.$('.//ion-card[contains(., "Kitchen Light")]//ion-range'); }
