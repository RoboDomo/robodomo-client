...
class OutsideTabComponent {
    ...
    get porchLightOnButton() { return this.activeTab.$('.//ion-label[text()="Porch Light"]/parent::*//ion-segment-button[.="On"]'); }
    get porchLightOffButton() { return this.activeTab.$('.//ion-label[text()="Porch Light"]/parent::*//ion-segment-button[.="Off"]'); }
    get porchLightLi() { return this.porchLightOnButton.$('./ancestor::li')}

    get outsideLightOnButton() { return this.activeTab.$('.//ion-label[text()="Outside Light"]/parent::*//ion-segment-button[.="On"]'); }
    get outsideLightOffButton() { return this.activeTab.$('.//ion-label[text()="Outside Light"]/parent::*//ion-segment-button[.="Off"]'); }
    get outsideLightLi() { return this.outsideLightOnButton.$('./ancestor::li')}

    get outdoorLightsOnButton() { return this.activeTab.$('.//ion-label[text()="Outdoor Lights"]/parent::*//ion-segment-button[.="On"]'); }
    get outdoorLightsOffButton() { return this.activeTab.$('.//ion-label[text()="Outdoor Lights"]/parent::*//ion-segment-button[.="Off"]'); }
