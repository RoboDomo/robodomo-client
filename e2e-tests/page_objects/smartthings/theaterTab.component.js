...
class TheaterTabComponent {
    get ceilingFanLightSwitch() {
        return $('//div[text()="Ceiling Fan Light"]/parent::*//ion-toggle');
    }
    get ceilingFanLightDimm() {
        return $('//div[text()="Ceiling Fan Light"]/parent::*//ion-range');
    }

    get ceilingFanOffButton() {
        return $('//div[text()="Ceiling Fan"]/parent::*//ion-segment-button[.="Off"]');
    }
    get ceilingFanLowButton() {
        return $('//div[text()="Ceiling Fan"]/parent::*//ion-segment-button[.="Low"]');
    }
    get ceilingFanMediumButton() {
        return $('//div[text()="Ceiling Fan"]/parent::*//ion-segment-button[.="Medium"]');
    }
    get ceilingFanHighButton() {
        return $('//div[text()="Ceiling Fan"]/parent::*//ion-segment-button[.="High"]');
    }
    ...
    validateCeilingFanState(state) {
        if (state === 'Off') expect(this.ceilingFanOffButton.getProperty('checked')).toEqual(true);
        else if (state === 'Low') expect(this.ceilingFanLowButton.getProperty('checked')).toEqual(true);
        else if (state === 'Medium') expect(this.ceilingFanMediumButton.getProperty('checked')).toEqual(true);
        else if (state === 'high') expect(this.ceilingFanHighButton.getProperty('checked')).toEqual(true);
    }
    ...
    validateCeilingFanLightState(state) {
        if (state === 'On') expect(this.ceilingFanLightSwitch.getAttribute('checked')).toEqual('true');
        else if (state === 'Off') expect(this.ceilingFanLightSwitch.getAttribute('checked')).toEqual('false');
    }
