...
class WeatherPage extends Page {
    ...
    get lATabButton() {
        return $('//*[@id="weather-tabs-tab-Los Angeles, CA"]');
    }
    get lATabPane() {
        return $('//*[@id="weather-tabs-tabpane-Los Angeles, CA"]');
    }

    get nYTabButton() {
        return $('//*[@id="weather-tabs-tab-New York, NY"]');
    }
    get nYTabPane() {
        return $('//*[@id="weather-tabs-tabpane-New York, NY"]');
    }
