...
const AudioControl = ({ avr }) =>
  avr ? (
    <>
      <IonList lines="none">
        <IonListHeader mode="md">Master Volume</IonListHeader>
      ...
      <IonList lines="none">
        <IonListHeader mode="md">Center Channel</IonListHeader>
      ...
      <IonList lines="none">
        <IonListHeader mode="md">{avr.surroundMode}</IonListHeader>
